...
export const THOUGHT_PATTERNS = [
  { id: ThoughtPattern.JUDGMENT, description: "나도 모르게 '옳고 그름'을 따지며 상대를 가두고 있나요?" },
  { id: ThoughtPattern.CRITICISM, description: "나 혹은 상대방에게 화살을 돌리며 탓하고 있지는 않나요?" },
  { id: ThoughtPattern.DEMAND, description: "'무조건 이래야 해'라는 압박으로 숨이 막히지는 않나요?" },
  { id: ThoughtPattern.COMPARISON, description: "다른 사람과 비교하며 내 가치를 깎아내리고 있나요?" },
  { id: ThoughtPattern.DESERVE, description: "상대가 당연히 해줘야 한다는 생각에 서운함이 쌓였나요?" },
  { id: ThoughtPattern.RATIONALIZATION, description: "내 진짜 마음을 숨기려 핑계를 찾고 있지는 않나요?" },
];
